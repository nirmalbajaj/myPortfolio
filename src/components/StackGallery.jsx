...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: '/react.svg', text: 'React' },
      { image: '/python.png', text: 'Python' },
      { image: '/bootstrap.svg', text: 'BootStrap' },
      { image: '/css-3.svg', text: 'CSS3' },
      { image: '/docker-icon.svg', text: 'Docker' },
      { image: '/Express.png', text: 'Express.js' },
      { image: '/fastapi-icon.svg', text: 'FasAPI' },
      { image: '/figma.svg', text: 'Figma' },
      { image: '/html-5.svg', text: 'HTML5' },
      { image: 'java.svg', text: 'Java' },
      { image: 'javascript.svg', text: 'Javascript' },
      { image: 'jquery.svg', text: 'Jquery' },
      { image: 'json-schema-icon.svg', text: 'JSON Schema' },
      { image: 'mongodb-icon.svg', text: 'MongoDB' },
